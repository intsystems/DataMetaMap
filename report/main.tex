...
\begin{table}[htbp]
\centering
\caption{Accuracy of Task2Vec-based pretraining selection compared to random and large-scale (ImageNet) baselines.}
\label{tab:task2vec_transfer}
{\scriptsize
\begin{tabular}{@{}lccccc@{}}
\toprule
& \textbf{MNIST} & \textbf{CIFAR-10} & \textbf{CIFAR-100} & \textbf{Letters} & \textbf{KMNIST} \\
\midrule
Task2Vec    & 0.9960 & 0.8798 & 0.4960 & 0.9326 & 0.9957 \\
Random      & 0.9815 & 0.6390 & 0.3512 & 0.9335 & 0.9752 \\
Big pretrain (ImageNet) & 0.9848 & 0.8834 & 0.6789 & 0.9197 & 0.9851 \\
\bottomrule
\end{tabular}
}
\end{table}
...
embedding space. A typical visualisation of the learned embedding
space is provided in Figure~\ref{fig:dataset2vec_demo}.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\columnwidth]{dataset2vec.jpeg}
    \caption{t‑SNE projection of Dataset2Vec embeddings on a synthetic tabular meta‑dataset. Colours indicate ground‑truth dataset type (circles, moons, blobs).}
    \label{fig:dataset2vec_demo}
\end{figure}
